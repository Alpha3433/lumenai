        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl font-bold tracking-tight mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">
              Industry-Leading Business Reports
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Dive Into Actionable Insights &amp; Data-Driven Strategies from Top Performers
            </p>
          </motion.div>
        </div>
        
        {/* Single grid for all companies in a 2x3 layout */}
