    ...
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-12">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-2">
          See the Difference: LLM Prompts vs. Lumen AI
        </h2>
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          Wondering if a generic chatbot is enough? Here's how our purpose-built business planning platform outperforms generic AI prompts—saving you hours and delivering real business value.
        </p>
      </div>
