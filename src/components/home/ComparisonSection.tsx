...
const ComparisonSection = () => <section className="py-20 px-4 bg-gradient-to-b from-[#F1F0FB] to-white dark:from-gray-950/80 dark:to-gray-900">
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-12">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-2">Same Prompt, Smarter Output</h2>
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">See how our purpose-built platform goes beyond basic AI prompts—saving you hours and delivering real, measurable business value.
