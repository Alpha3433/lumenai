...
const RoadmapSection = () => {
  ...
  return <section ref={sectionRef} className="py-24 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-16">
          ...
          duration: 0.5
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Digital Strategies That Scale Your Business</h2>
          ...
          duration: 0.5
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden shadow-xl p-1">
              <img src="/lovable-uploads/7ba1cf6a-2c1c-45f8-aed6-d8ef4560c984.png" alt="Digital Marketing Consulting" className="w-full h-auto rounded-lg" />
            </div>
          </motion.div>
        </div>
      </div>
