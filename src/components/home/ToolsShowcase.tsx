...
const ToolsShowcase = () => {
  return <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-950">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          delay: 0.1
            ...
            <div className="flex items-center mb-4">
              ...
              <h3 className="font-semibold text-lg">Expert Consulting</h3>
            </div>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Get expert consulting with in-depth market analysis, competitive insights, and tailored growth strategies to uncover your biggest opportunities.</p>
          </motion.div>
