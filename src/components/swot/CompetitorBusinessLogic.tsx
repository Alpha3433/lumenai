...
import { CompetitorWithBusinessModel, inferPricingModel } from './utils/competitorCardUtils';

interface UseCompetitorsResult {
  competitorsWithModels: CompetitorWithBusinessModel[];
  isLoading: boolean;
}

export const useCompetitors = (marketAnalysis: string): UseCompetitorsResult => {
