      ...
      <Card className="h-full border border-gray-200 dark:border-gray-800 hover:shadow-lg transition-all duration-300">
        <CardContent className="p-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className={`text-sm font-medium ${status === 'live' ? 'text-green-600 dark:text-green-400' : 
              status === 'coming-soon' ? 'text-blue-600 dark:text-blue-400' : 
...
const RoadmapSection = () => {
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
