      ...
      <Card className="h-full border border-gray-200 dark:border-gray-800 shadow-md hover:shadow-lg transition-shadow duration-300 bg-white dark:bg-gray-900 overflow-hidden group">
        <CardContent className="p-6 h-full flex flex-col">
          <motion.div 
            ...
            className="mb-4 w-12 h-12 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 group-hover:bg-blue-200 dark:group-hover:bg-blue-800/40 transition-colors"
          >
            {icon}
          </motion.div>
...
const WhoItsForSection = () => {
  ...
  return (
    <section id="who-its-for" className="py-20 px-4 bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-6xl mx-auto" ref={ref}>
        <div className="text-center mb-16 relative">
          ...
          <motion.div 
            className="absolute left-1/2 -bottom-4 h-1 bg-gradient-to-r from-blue-500 to-green-500 transform -translate-x-1/2 rounded-full"
        ...
        <motion.div 
          ...
          animate={controls}
        >
          <p className="text-lg text-gray-700 dark:text-gray-200 font-medium inline-block px-8 py-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
