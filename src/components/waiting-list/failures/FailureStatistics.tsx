    ...
    >
      <div className="p-6 space-y-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Top Startup Failure Reasons</h3>
        </div>
          ...
          {failureReasons.map((item, index) => (
            ...
            >
              <div className="flex justify-between items-center">
                <span className="text-gray-700 dark:text-gray-200 font-medium">{item.reason}</span>
                <span className="text-red-600 dark:text-red-400 font-bold">{item.percentage}%</span>
              </div>
              <div className="h-2 bg-gray-100 dark:bg-gray-700 rounded-full w-full overflow-hidden">
                <motion.div 
                  className="h-full bg-gradient-to-r from-red-400 to-red-500 dark:from-red-500 dark:to-red-400 rounded-full"
                  style={{ width: "0%" }}
