        ...
        >
          <div className="relative flex-shrink-0">
            ...
            {index < steps.length - 1 && (
              <div className="absolute left-1/2 top-14 bottom-0 w-1 h-[calc(100%-42px)] -translate-x-1/2 bg-gradient-to-b from-purple-300 to-blue-300 dark:from-purple-900/50 dark:to-blue-900/30"></div>
            )}
          </div>
          <motion.div 
            className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border border-gray-100 dark:border-gray-700 transition-all duration-300 group-hover:shadow-xl group-hover:-translate-y-1 w-full"
